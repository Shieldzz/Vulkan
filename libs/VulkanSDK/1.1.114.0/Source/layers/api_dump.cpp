...
inline void dump_vkCreateWin32SurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkWin32SurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Json:
        dump_json_vkCreateWin32SurfaceKHR(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
...
inline void dump_vkBindBufferMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkBuffer buffer, VkDeviceMemory memory, VkDeviceSize memoryOffset)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindBufferMemory(dump_inst, result, device, buffer, memory, memoryOffset);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkBindImageMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkImage image, VkDeviceMemory memory, VkDeviceSize memoryOffset)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindImageMemory(dump_inst, result, device, image, memory, memoryOffset);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceWin32PresentationSupportKHR(ApiDumpInstance& dump_inst, VkBool32 result, VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceWin32PresentationSupportKHR(dump_inst, result, physicalDevice, queueFamilyIndex);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateDescriptorUpdateTemplate(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDescriptorUpdateTemplateCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorUpdateTemplate* pDescriptorUpdateTemplate)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDescriptorUpdateTemplate(dump_inst, result, device, pCreateInfo, pAllocator, pDescriptorUpdateTemplate);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
inline void dump_vkGetPhysicalDeviceSurfacePresentModes2EXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceSurfacePresentModes2EXT(dump_inst, result, physicalDevice, pSurfaceInfo, pPresentModeCount, pPresentModes);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetPhysicalDeviceSurfacePresentModes2EXT(dump_inst, result, physicalDevice, pSurfaceInfo, pPresentModeCount, pPresentModes);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfacePresentModes2EXT(dump_inst, result, physicalDevice, pSurfaceInfo, pPresentModeCount, pPresentModes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#endif // VK_USE_PLATFORM_WIN32_KHR
#if defined(VK_USE_PLATFORM_WIN32_KHR)
inline void dump_vkReleaseFullScreenExclusiveModeEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkReleaseFullScreenExclusiveModeEXT(dump_inst, result, device, swapchain);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkReleaseFullScreenExclusiveModeEXT(dump_inst, result, device, swapchain);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkReleaseFullScreenExclusiveModeEXT(dump_inst, result, device, swapchain);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#endif // VK_USE_PLATFORM_WIN32_KHR
#if defined(VK_USE_PLATFORM_WIN32_KHR)
inline void dump_vkAcquireFullScreenExclusiveModeEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkAcquireFullScreenExclusiveModeEXT(dump_inst, result, device, swapchain);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkAcquireFullScreenExclusiveModeEXT(dump_inst, result, device, swapchain);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAcquireFullScreenExclusiveModeEXT(dump_inst, result, device, swapchain);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateFramebuffer(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkFramebufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFramebuffer* pFramebuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateFramebuffer(dump_inst, result, device, pCreateInfo, pAllocator, pFramebuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateFence(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkFenceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateFence(dump_inst, result, device, pCreateInfo, pAllocator, pFence);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDisplayPlaneSupportedDisplaysKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t planeIndex, uint32_t* pDisplayCount, VkDisplayKHR* pDisplays)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDisplayPlaneSupportedDisplaysKHR(dump_inst, result, physicalDevice, planeIndex, pDisplayCount, pDisplays);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateRenderPass2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkRenderPassCreateInfo2KHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateRenderPass2KHR(dump_inst, result, device, pCreateInfo, pAllocator, pRenderPass);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#if defined(VK_USE_PLATFORM_WIN32_KHR)
inline void dump_vkGetDeviceGroupSurfacePresentModes2EXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, VkDeviceGroupPresentModeFlagsKHR* pModes)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetDeviceGroupSurfacePresentModes2EXT(dump_inst, result, device, pSurfaceInfo, pModes);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetDeviceGroupSurfacePresentModes2EXT(dump_inst, result, device, pSurfaceInfo, pModes);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceGroupSurfacePresentModes2EXT(dump_inst, result, device, pSurfaceInfo, pModes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#endif // VK_USE_PLATFORM_WIN32_KHR
inline void dump_vkCreateHeadlessSurfaceEXT(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkHeadlessSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCreateHeadlessSurfaceEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCreateHeadlessSurfaceEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateHeadlessSurfaceEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceDisplayPropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPropertiesKHR* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceDisplayPropertiesKHR(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceDisplayPlanePropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlanePropertiesKHR* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceDisplayPlanePropertiesKHR(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDisplayModePropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint32_t* pPropertyCount, VkDisplayModePropertiesKHR* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDisplayModePropertiesKHR(dump_inst, result, physicalDevice, display, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateRenderPass(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkRenderPassCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateRenderPass(dump_inst, result, device, pCreateInfo, pAllocator, pRenderPass);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDisplayModeKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkDisplayKHR display, const VkDisplayModeCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDisplayModeKHR* pMode)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDisplayModeKHR(dump_inst, result, physicalDevice, display, pCreateInfo, pAllocator, pMode);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueBindSparse(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, uint32_t bindInfoCount, const VkBindSparseInfo* pBindInfo, VkFence fence)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueBindSparse(dump_inst, result, queue, bindInfoCount, pBindInfo, fence);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDisplayPlaneCapabilitiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkDisplayModeKHR mode, uint32_t planeIndex, VkDisplayPlaneCapabilitiesKHR* pCapabilities)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDisplayPlaneCapabilitiesKHR(dump_inst, result, physicalDevice, mode, planeIndex, pCapabilities);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateWaylandSurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkWaylandSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateWaylandSurfaceKHR(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateCommandPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkCommandPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkCommandPool* pCommandPool)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateCommandPool(dump_inst, result, device, pCreateInfo, pAllocator, pCommandPool);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumeratePhysicalDevices(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, uint32_t* pPhysicalDeviceCount, VkPhysicalDevice* pPhysicalDevices)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumeratePhysicalDevices(dump_inst, result, instance, pPhysicalDeviceCount, pPhysicalDevices);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceWaylandPresentationSupportKHR(ApiDumpInstance& dump_inst, VkBool32 result, VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, struct wl_display* display)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceWaylandPresentationSupportKHR(dump_inst, result, physicalDevice, queueFamilyIndex, display);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceImageFormatProperties(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage, VkImageCreateFlags flags, VkImageFormatProperties* pImageFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceImageFormatProperties(dump_inst, result, physicalDevice, format, type, tiling, usage, flags, pImageFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumeratePhysicalDeviceGroupsKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, uint32_t* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumeratePhysicalDeviceGroupsKHR(dump_inst, result, instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDisplayModeProperties2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkDisplayKHR display, uint32_t* pPropertyCount, VkDisplayModeProperties2KHR* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDisplayModeProperties2KHR(dump_inst, result, physicalDevice, display, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceDisplayProperties2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayProperties2KHR* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceDisplayProperties2KHR(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceImageFormatProperties2(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceImageFormatInfo2* pImageFormatInfo, VkImageFormatProperties2* pImageFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceImageFormatProperties2(dump_inst, result, physicalDevice, pImageFormatInfo, pImageFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceDisplayPlaneProperties2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkDisplayPlaneProperties2KHR* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceDisplayPlaneProperties2KHR(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryWin32HandlePropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, HANDLE handle, VkMemoryWin32HandlePropertiesKHR* pMemoryWin32HandleProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryWin32HandlePropertiesKHR(dump_inst, result, device, handleType, handle, pMemoryWin32HandleProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetDisplayPlaneCapabilities2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkDisplayPlaneInfo2KHR* pDisplayPlaneInfo, VkDisplayPlaneCapabilities2KHR* pCapabilities)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDisplayPlaneCapabilities2KHR(dump_inst, result, physicalDevice, pDisplayPlaneInfo, pCapabilities);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryWin32HandleKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkMemoryGetWin32HandleInfoKHR* pGetWin32HandleInfo, HANDLE* pHandle)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryWin32HandleKHR(dump_inst, result, device, pGetWin32HandleInfo, pHandle);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateIOSSurfaceMVK(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkIOSSurfaceCreateInfoMVK* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateIOSSurfaceMVK(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateSwapchainKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSwapchainCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSwapchainKHR* pSwapchain)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateSwapchainKHR(dump_inst, result, device, pCreateInfo, pAllocator, pSwapchain);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkResetCommandPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkCommandPool commandPool, VkCommandPoolResetFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkResetCommandPool(dump_inst, result, device, commandPool, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkAllocateCommandBuffers(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkCommandBufferAllocateInfo* pAllocateInfo, VkCommandBuffer* pCommandBuffers)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAllocateCommandBuffers(dump_inst, result, device, pAllocateInfo, pCommandBuffers);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateMacOSSurfaceMVK(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkMacOSSurfaceCreateInfoMVK* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateMacOSSurfaceMVK(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkImportSemaphoreWin32HandleKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportSemaphoreWin32HandleInfoKHR* pImportSemaphoreWin32HandleInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkImportSemaphoreWin32HandleKHR(dump_inst, result, device, pImportSemaphoreWin32HandleInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetCalibratedTimestampsEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t timestampCount, const VkCalibratedTimestampInfoEXT* pTimestampInfos, uint64_t* pTimestamps, uint64_t* pMaxDeviation)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetCalibratedTimestampsEXT(dump_inst, result, device, timestampCount, pTimestampInfos, pTimestamps, pMaxDeviation);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateComputePipelines(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkComputePipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateComputePipelines(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetFenceStatus(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkFence fence)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetFenceStatus(dump_inst, result, device, fence);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkSetDebugUtilsObjectTagEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDebugUtilsObjectTagInfoEXT* pTagInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkSetDebugUtilsObjectTagEXT(dump_inst, result, device, pTagInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkResetFences(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t fenceCount, const VkFence* pFences)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkResetFences(dump_inst, result, device, fenceCount, pFences);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pTimeDomainCount, VkTimeDomainEXT* pTimeDomains)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceCalibrateableTimeDomainsEXT(dump_inst, result, physicalDevice, pTimeDomainCount, pTimeDomains);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetSemaphoreWin32HandleKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSemaphoreGetWin32HandleInfoKHR* pGetWin32HandleInfo, HANDLE* pHandle)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetSemaphoreWin32HandleKHR(dump_inst, result, device, pGetWin32HandleInfo, pHandle);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetSwapchainStatusKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetSwapchainStatusKHR(dump_inst, result, device, swapchain);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkImportSemaphoreFdKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportSemaphoreFdInfoKHR* pImportSemaphoreFdInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkImportSemaphoreFdKHR(dump_inst, result, device, pImportSemaphoreFdInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkWaitForFences(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t fenceCount, const VkFence* pFences, VkBool32 waitAll, uint64_t timeout)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkWaitForFences(dump_inst, result, device, fenceCount, pFences, waitAll, timeout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateXlibSurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkXlibSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateXlibSurfaceKHR(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateSemaphore(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSemaphoreCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSemaphore* pSemaphore)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateSemaphore(dump_inst, result, device, pCreateInfo, pAllocator, pSemaphore);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateEvent(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkEventCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkEvent* pEvent)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateEvent(dump_inst, result, device, pCreateInfo, pAllocator, pEvent);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceXlibPresentationSupportKHR(ApiDumpInstance& dump_inst, VkBool32 result, VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, Display* dpy, VisualID visualID)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceXlibPresentationSupportKHR(dump_inst, result, physicalDevice, queueFamilyIndex, dpy, visualID);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateDebugUtilsMessengerEXT(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pMessenger)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDebugUtilsMessengerEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pMessenger);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#if defined(VK_USE_PLATFORM_GGP)
inline void dump_vkCreateStreamDescriptorSurfaceGGP(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkStreamDescriptorSurfaceCreateInfoGGP* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCreateStreamDescriptorSurfaceGGP(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCreateStreamDescriptorSurfaceGGP(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateStreamDescriptorSurfaceGGP(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetSemaphoreFdKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSemaphoreGetFdInfoKHR* pGetFdInfo, int* pFd)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetSemaphoreFdKHR(dump_inst, result, device, pGetFdInfo, pFd);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreatePipelineLayout(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkPipelineLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineLayout* pPipelineLayout)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreatePipelineLayout(dump_inst, result, device, pCreateInfo, pAllocator, pPipelineLayout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkImportFenceWin32HandleKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportFenceWin32HandleInfoKHR* pImportFenceWin32HandleInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkImportFenceWin32HandleKHR(dump_inst, result, device, pImportFenceWin32HandleInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetEventStatus(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkEvent event)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetEventStatus(dump_inst, result, device, event);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkSetEvent(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkEvent event)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkSetEvent(dump_inst, result, device, event);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetFenceWin32HandleKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkFenceGetWin32HandleInfoKHR* pGetWin32HandleInfo, HANDLE* pHandle)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetFenceWin32HandleKHR(dump_inst, result, device, pGetWin32HandleInfo, pHandle);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateSamplerYcbcrConversion(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateSamplerYcbcrConversion(dump_inst, result, device, pCreateInfo, pAllocator, pYcbcrConversion);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkResetEvent(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkEvent event)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkResetEvent(dump_inst, result, device, event);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalImageFormatPropertiesNV(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkImageTiling tiling, VkImageUsageFlags usage, VkImageCreateFlags flags, VkExternalMemoryHandleTypeFlagsNV externalHandleType, VkExternalImageFormatPropertiesNV* pExternalImageFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalImageFormatPropertiesNV(dump_inst, result, physicalDevice, format, type, tiling, usage, flags, externalHandleType, pExternalImageFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateQueryPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkQueryPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkQueryPool* pQueryPool)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateQueryPool(dump_inst, result, device, pCreateInfo, pAllocator, pQueryPool);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumeratePhysicalDeviceGroups(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, uint32_t* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumeratePhysicalDeviceGroups(dump_inst, result, instance, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkImportFenceFdKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImportFenceFdInfoKHR* pImportFenceFdInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkImportFenceFdKHR(dump_inst, result, device, pImportFenceFdInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkReleaseDisplayEXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkDisplayKHR display)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkReleaseDisplayEXT(dump_inst, result, physicalDevice, display);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkBindBufferMemory2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfo* pBindInfos)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindBufferMemory2KHR(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateAndroidSurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkAndroidSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateAndroidSurfaceKHR(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkBindImageMemory2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindImageMemoryInfo* pBindInfos)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindImageMemory2KHR(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetFenceFdKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkFenceGetFdInfoKHR* pGetFdInfo, int* pFd)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetFenceFdKHR(dump_inst, result, device, pGetFdInfo, pFd);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetRandROutputDisplayEXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, Display* dpy, RROutput rrOutput, VkDisplayKHR* pDisplay)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetRandROutputDisplayEXT(dump_inst, result, physicalDevice, dpy, rrOutput, pDisplay);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetAndroidHardwareBufferPropertiesANDROID(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const struct AHardwareBuffer* buffer, VkAndroidHardwareBufferPropertiesANDROID* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetAndroidHardwareBufferPropertiesANDROID(dump_inst, result, device, buffer, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkAcquireXlibDisplayEXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, Display* dpy, VkDisplayKHR display)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAcquireXlibDisplayEXT(dump_inst, result, physicalDevice, dpy, display);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkBindBufferMemory2(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindBufferMemoryInfo* pBindInfos)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindBufferMemory2(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryAndroidHardwareBufferANDROID(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkMemoryGetAndroidHardwareBufferInfoANDROID* pInfo, struct AHardwareBuffer** pBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryAndroidHardwareBufferANDROID(dump_inst, result, device, pInfo, pBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkBindImageMemory2(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindImageMemoryInfo* pBindInfos)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindImageMemory2(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageDrmFormatModifierPropertiesEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkImage image, VkImageDrmFormatModifierPropertiesEXT* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageDrmFormatModifierPropertiesEXT(dump_inst, result, device, image, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSurfaceCapabilities2EXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkSurfaceCapabilities2EXT* pSurfaceCapabilities)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfaceCapabilities2EXT(dump_inst, result, physicalDevice, surface, pSurfaceCapabilities);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDebugReportCallbackEXT(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkDebugReportCallbackCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugReportCallbackEXT* pCallback)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDebugReportCallbackEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pCallback);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkBeginCommandBuffer(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer, const VkCommandBufferBeginInfo* pBeginInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBeginCommandBuffer(dump_inst, result, commandBuffer, pBeginInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEndCommandBuffer(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEndCommandBuffer(dump_inst, result, commandBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetSwapchainImagesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain, uint32_t* pSwapchainImageCount, VkImage* pSwapchainImages)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetSwapchainImagesKHR(dump_inst, result, device, swapchain, pSwapchainImageCount, pSwapchainImages);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateIndirectCommandsLayoutNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkIndirectCommandsLayoutCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkIndirectCommandsLayoutNVX* pIndirectCommandsLayout)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateIndirectCommandsLayoutNVX(dump_inst, result, device, pCreateInfo, pAllocator, pIndirectCommandsLayout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateObjectTableNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkObjectTableCreateInfoNVX* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkObjectTableNVX* pObjectTable)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateObjectTableNVX(dump_inst, result, device, pCreateInfo, pAllocator, pObjectTable);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkRegisterObjectsNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectTableEntryNVX* const*    ppObjectTableEntries, const uint32_t* pObjectIndices)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkRegisterObjectsNVX(dump_inst, result, device, objectTable, objectCount, ppObjectTableEntries, pObjectIndices);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkUnregisterObjectsNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const VkObjectEntryTypeNVX* pObjectEntryTypes, const uint32_t* pObjectIndices)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkUnregisterObjectsNVX(dump_inst, result, device, objectTable, objectCount, pObjectEntryTypes, pObjectIndices);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkResetCommandBuffer(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer, VkCommandBufferResetFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkResetCommandBuffer(dump_inst, result, commandBuffer, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkAcquireNextImageKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain, uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t* pImageIndex)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAcquireNextImageKHR(dump_inst, result, device, swapchain, timeout, semaphore, fence, pImageIndex);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueuePresentKHR(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, const VkPresentInfoKHR* pPresentInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueuePresentKHR(dump_inst, result, queue, pPresentInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateSampler(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSamplerCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSampler* pSampler)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateSampler(dump_inst, result, device, pCreateInfo, pAllocator, pSampler);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDisplayPlaneSurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkDisplaySurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDisplayPlaneSurfaceKHR(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkRegisterDeviceEventEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDeviceEventInfoEXT* pDeviceEventInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkRegisterDeviceEventEXT(dump_inst, result, device, pDeviceEventInfo, pAllocator, pFence);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDisplayPowerControlEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDisplayKHR display, const VkDisplayPowerInfoEXT* pDisplayPowerInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDisplayPowerControlEXT(dump_inst, result, device, display, pDisplayPowerInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageViewHandleNVX(ApiDumpInstance& dump_inst, uint32_t result, VkDevice device, const VkImageViewHandleInfoNVX* pInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetImageViewHandleNVX(dump_inst, result, device, pInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetImageViewHandleNVX(dump_inst, result, device, pInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageViewHandleNVX(dump_inst, result, device, pInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkRegisterDisplayEventEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDisplayKHR display, const VkDisplayEventInfoEXT* pDisplayEventInfo, const VkAllocationCallbacks* pAllocator, VkFence* pFence)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkRegisterDisplayEventEXT(dump_inst, result, device, display, pDisplayEventInfo, pAllocator, pFence);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetSwapchainCounterEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain, VkSurfaceCounterFlagBitsEXT counter, uint64_t* pCounterValue)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetSwapchainCounterEXT(dump_inst, result, device, swapchain, counter, pCounterValue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateImageView(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImageViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImageView* pView)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateImageView(dump_inst, result, device, pCreateInfo, pAllocator, pView);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPastPresentationTimingGOOGLE(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain, uint32_t* pPresentationTimingCount, VkPastPresentationTimingGOOGLE* pPresentationTimings)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPastPresentationTimingGOOGLE(dump_inst, result, device, swapchain, pPresentationTimingCount, pPresentationTimings);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeMatrixPropertiesNV* pProperties)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDescriptorPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDescriptorPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorPool* pDescriptorPool)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDescriptorPool(dump_inst, result, device, pCreateInfo, pAllocator, pDescriptorPool);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetQueryPoolResults(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, size_t dataSize, void* pData, VkDeviceSize stride, VkQueryResultFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetQueryPoolResults(dump_inst, result, device, queryPool, firstQuery, queryCount, dataSize, pData, stride, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateSharedSwapchainsKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t swapchainCount, const VkSwapchainCreateInfoKHR* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkSwapchainKHR* pSwapchains)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateSharedSwapchainsKHR(dump_inst, result, device, swapchainCount, pCreateInfos, pAllocator, pSwapchains);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateBuffer(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkBufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBuffer* pBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateBuffer(dump_inst, result, device, pCreateInfo, pAllocator, pBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkFreeDescriptorSets(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDescriptorPool descriptorPool, uint32_t descriptorSetCount, const VkDescriptorSet* pDescriptorSets)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkFreeDescriptorSets(dump_inst, result, device, descriptorPool, descriptorSetCount, pDescriptorSets);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetRefreshCycleDurationGOOGLE(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain, VkRefreshCycleDurationGOOGLE* pDisplayTimingProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetRefreshCycleDurationGOOGLE(dump_inst, result, device, swapchain, pDisplayTimingProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDescriptorSetLayout(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDescriptorSetLayoutCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorSetLayout* pSetLayout)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDescriptorSetLayout(dump_inst, result, device, pCreateInfo, pAllocator, pSetLayout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkResetDescriptorPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDescriptorPool descriptorPool, VkDescriptorPoolResetFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkResetDescriptorPool(dump_inst, result, device, descriptorPool, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(dump_inst, result, physicalDevice, pCombinationCount, pCombinations);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(dump_inst, result, physicalDevice, pCombinationCount, pCombinations);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(dump_inst, result, physicalDevice, pCombinationCount, pCombinations);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkAllocateDescriptorSets(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDescriptorSetAllocateInfo* pAllocateInfo, VkDescriptorSet* pDescriptorSets)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAllocateDescriptorSets(dump_inst, result, device, pAllocateInfo, pDescriptorSets);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetShaderInfoAMD(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipeline pipeline, VkShaderStageFlagBits shaderStage, VkShaderInfoTypeAMD infoType, size_t* pInfoSize, void* pInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetShaderInfoAMD(dump_inst, result, device, pipeline, shaderStage, infoType, pInfoSize, pInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkMergeValidationCachesEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkValidationCacheEXT dstCache, uint32_t srcCacheCount, const VkValidationCacheEXT* pSrcCaches)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkMergeValidationCachesEXT(dump_inst, result, device, dstCache, srcCacheCount, pSrcCaches);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateValidationCacheEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkValidationCacheCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkValidationCacheEXT* pValidationCache)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateValidationCacheEXT(dump_inst, result, device, pCreateInfo, pAllocator, pValidationCache);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSurfaceFormatsKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pSurfaceFormatCount, VkSurfaceFormatKHR* pSurfaceFormats)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfaceFormatsKHR(dump_inst, result, physicalDevice, surface, pSurfaceFormatCount, pSurfaceFormats);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumerateDeviceExtensionProperties(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const char* pLayerName, uint32_t* pPropertyCount, VkExtensionProperties* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumerateDeviceExtensionProperties(dump_inst, result, physicalDevice, pLayerName, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumerateInstanceExtensionProperties(ApiDumpInstance& dump_inst, VkResult result, const char* pLayerName, uint32_t* pPropertyCount, VkExtensionProperties* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumerateInstanceExtensionProperties(dump_inst, result, pLayerName, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceImageFormatProperties2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceImageFormatInfo2* pImageFormatInfo, VkImageFormatProperties2* pImageFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceImageFormatProperties2KHR(dump_inst, result, physicalDevice, pImageFormatInfo, pImageFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetMemoryFdPropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, int fd, VkMemoryFdPropertiesKHR* pMemoryFdProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryFdPropertiesKHR(dump_inst, result, device, handleType, fd, pMemoryFdProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetValidationCacheDataEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkValidationCacheEXT validationCache, size_t* pDataSize, void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetValidationCacheDataEXT(dump_inst, result, device, validationCache, pDataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR* pSurfaceCapabilities)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(dump_inst, result, physicalDevice, surface, pSurfaceCapabilities);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateShaderModule(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkShaderModuleCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkShaderModule* pShaderModule)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateShaderModule(dump_inst, result, device, pCreateInfo, pAllocator, pShaderModule);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateAccelerationStructureNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkAccelerationStructureCreateInfoNV* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkAccelerationStructureNV* pAccelerationStructure)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateAccelerationStructureNV(dump_inst, result, device, pCreateInfo, pAllocator, pAccelerationStructure);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetMemoryFdKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkMemoryGetFdInfoKHR* pGetFdInfo, int* pFd)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryFdKHR(dump_inst, result, device, pGetFdInfo, pFd);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueWaitIdle(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueWaitIdle(dump_inst, result, queue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumerateInstanceLayerProperties(ApiDumpInstance& dump_inst, VkResult result, uint32_t* pPropertyCount, VkLayerProperties* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumerateInstanceLayerProperties(dump_inst, result, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDebugMarkerSetObjectTagEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDebugMarkerObjectTagInfoEXT* pTagInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDebugMarkerSetObjectTagEXT(dump_inst, result, device, pTagInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreatePipelineCache(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkPipelineCacheCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkPipelineCache* pPipelineCache)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreatePipelineCache(dump_inst, result, device, pCreateInfo, pAllocator, pPipelineCache);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDeviceWaitIdle(ApiDumpInstance& dump_inst, VkResult result, VkDevice device)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDeviceWaitIdle(dump_inst, result, device);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetBufferDeviceAddressEXT(ApiDumpInstance& dump_inst, VkDeviceAddress result, VkDevice device, const VkBufferDeviceAddressInfoEXT* pInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetBufferDeviceAddressEXT(dump_inst, result, device, pInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkAllocateMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkMemoryAllocateInfo* pAllocateInfo, const VkAllocationCallbacks* pAllocator, VkDeviceMemory* pMemory)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAllocateMemory(dump_inst, result, device, pAllocateInfo, pAllocator, pMemory);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkEnumerateDeviceLayerProperties(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkLayerProperties* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkEnumerateDeviceLayerProperties(dump_inst, result, physicalDevice, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueSubmit(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, uint32_t submitCount, const VkSubmitInfo* pSubmits, VkFence fence)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueSubmit(dump_inst, result, queue, submitCount, pSubmits, fence);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDevice(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkDeviceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDevice* pDevice)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDevice(dump_inst, result, physicalDevice, pCreateInfo, pAllocator, pDevice);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkMapMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory, VkDeviceSize offset, VkDeviceSize size, VkMemoryMapFlags flags, void** ppData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkMapMemory(dump_inst, result, device, memory, offset, size, flags, ppData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSurfacePresentModesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfacePresentModesKHR(dump_inst, result, physicalDevice, surface, pPresentModeCount, pPresentModes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkBindAccelerationStructureMemoryNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t bindInfoCount, const VkBindAccelerationStructureMemoryInfoNV* pBindInfos)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkBindAccelerationStructureMemoryNV(dump_inst, result, device, bindInfoCount, pBindInfos);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceGroupPresentCapabilitiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceGroupPresentCapabilitiesKHR* pDeviceGroupPresentCapabilities)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceGroupPresentCapabilitiesKHR(dump_inst, result, device, pDeviceGroupPresentCapabilities);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDevicePresentRectanglesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, VkSurfaceKHR surface, uint32_t* pRectCount, VkRect2D* pRects)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDevicePresentRectanglesKHR(dump_inst, result, physicalDevice, surface, pRectCount, pRects);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateViSurfaceNN(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkViSurfaceCreateInfoNN* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateViSurfaceNN(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPipelineCacheData(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache pipelineCache, size_t* pDataSize, void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPipelineCacheData(dump_inst, result, device, pipelineCache, pDataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceGroupSurfacePresentModesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSurfaceKHR surface, VkDeviceGroupPresentModeFlagsKHR* pModes)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceGroupSurfacePresentModesKHR(dump_inst, result, device, surface, pModes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkMergePipelineCaches(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache dstCache, uint32_t srcCacheCount, const VkPipelineCache* pSrcCaches)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkMergePipelineCaches(dump_inst, result, device, dstCache, srcCacheCount, pSrcCaches);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkAcquireNextImage2KHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkAcquireNextImageInfoKHR* pAcquireInfo, uint32_t* pImageIndex)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAcquireNextImage2KHR(dump_inst, result, device, pAcquireInfo, pImageIndex);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkFlushMappedMemoryRanges(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkFlushMappedMemoryRanges(dump_inst, result, device, memoryRangeCount, pMemoryRanges);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateGraphicsPipelines(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkGraphicsPipelineCreateInfo* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateGraphicsPipelines(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateRayTracingPipelinesNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache pipelineCache, uint32_t createInfoCount, const VkRayTracingPipelineCreateInfoNV* pCreateInfos, const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateRayTracingPipelinesNV(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, pPipelines);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkInvalidateMappedMemoryRanges(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t memoryRangeCount, const VkMappedMemoryRange* pMemoryRanges)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkInvalidateMappedMemoryRanges(dump_inst, result, device, memoryRangeCount, pMemoryRanges);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetRayTracingShaderGroupHandlesNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetRayTracingShaderGroupHandlesNV(dump_inst, result, device, pipeline, firstGroup, groupCount, dataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateDescriptorUpdateTemplateKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDescriptorUpdateTemplateCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDescriptorUpdateTemplate* pDescriptorUpdateTemplate)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateDescriptorUpdateTemplateKHR(dump_inst, result, device, pCreateInfo, pAllocator, pDescriptorUpdateTemplate);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetAccelerationStructureHandleNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkAccelerationStructureNV accelerationStructure, size_t dataSize, void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetAccelerationStructureHandleNV(dump_inst, result, device, accelerationStructure, dataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryWin32HandleNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory, VkExternalMemoryHandleTypeFlagsNV handleType, HANDLE* pHandle)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryWin32HandleNV(dump_inst, result, device, memory, handleType, pHandle);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateBufferView(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkBufferViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkBufferView* pView)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateBufferView(dump_inst, result, device, pCreateInfo, pAllocator, pView);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSurfaceFormats2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint32_t* pSurfaceFormatCount, VkSurfaceFormat2KHR* pSurfaceFormats)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfaceFormats2KHR(dump_inst, result, physicalDevice, pSurfaceInfo, pSurfaceFormatCount, pSurfaceFormats);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateImagePipeSurfaceFUCHSIA(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkImagePipeSurfaceCreateInfoFUCHSIA* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateImagePipeSurfaceFUCHSIA(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceSurfaceCapabilities2KHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, VkSurfaceCapabilities2KHR* pSurfaceCapabilities)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfaceCapabilities2KHR(dump_inst, result, physicalDevice, pSurfaceInfo, pSurfaceCapabilities);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCompileDeferredNV(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipeline pipeline, uint32_t shader)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCompileDeferredNV(dump_inst, result, device, pipeline, shader);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkInitializePerformanceApiINTEL(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkInitializePerformanceApiInfoINTEL* pInitializeInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkInitializePerformanceApiINTEL(dump_inst, result, device, pInitializeInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkInitializePerformanceApiINTEL(dump_inst, result, device, pInitializeInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkInitializePerformanceApiINTEL(dump_inst, result, device, pInitializeInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateXcbSurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkXcbSurfaceCreateInfoKHR* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateXcbSurfaceKHR(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCreateImage(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImageCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkImage* pImage)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateImage(dump_inst, result, device, pCreateInfo, pAllocator, pImage);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetPerformanceMarkerINTEL(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer, const VkPerformanceMarkerInfoINTEL* pMarkerInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdSetPerformanceMarkerINTEL(dump_inst, result, commandBuffer, pMarkerInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdSetPerformanceMarkerINTEL(dump_inst, result, commandBuffer, pMarkerInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetPerformanceMarkerINTEL(dump_inst, result, commandBuffer, pMarkerInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#if defined(VK_USE_PLATFORM_METAL_EXT)
inline void dump_vkCreateMetalSurfaceEXT(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance, const VkMetalSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCreateMetalSurfaceEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCreateMetalSurfaceEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateMetalSurfaceEXT(dump_inst, result, instance, pCreateInfo, pAllocator, pSurface);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetMemoryHostPointerPropertiesEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, const void* pHostPointer, VkMemoryHostPointerPropertiesEXT* pMemoryHostPointerProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetMemoryHostPointerPropertiesEXT(dump_inst, result, device, handleType, pHostPointer, pMemoryHostPointerProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetPerformanceStreamMarkerINTEL(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer, const VkPerformanceStreamMarkerInfoINTEL* pMarkerInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdSetPerformanceStreamMarkerINTEL(dump_inst, result, commandBuffer, pMarkerInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdSetPerformanceStreamMarkerINTEL(dump_inst, result, commandBuffer, pMarkerInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetPerformanceStreamMarkerINTEL(dump_inst, result, commandBuffer, pMarkerInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetPerformanceOverrideINTEL(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer, const VkPerformanceOverrideInfoINTEL* pOverrideInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkCmdSetPerformanceOverrideINTEL(dump_inst, result, commandBuffer, pOverrideInfo);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkCmdSetPerformanceOverrideINTEL(dump_inst, result, commandBuffer, pOverrideInfo);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetPerformanceOverrideINTEL(dump_inst, result, commandBuffer, pOverrideInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkReleasePerformanceConfigurationINTEL(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPerformanceConfigurationINTEL configuration)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkReleasePerformanceConfigurationINTEL(dump_inst, result, device, configuration);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkReleasePerformanceConfigurationINTEL(dump_inst, result, device, configuration);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkReleasePerformanceConfigurationINTEL(dump_inst, result, device, configuration);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkGetPhysicalDeviceXcbPresentationSupportKHR(ApiDumpInstance& dump_inst, VkBool32 result, VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, xcb_connection_t* connection, xcb_visualid_t visual_id)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceXcbPresentationSupportKHR(dump_inst, result, physicalDevice, queueFamilyIndex, connection, visual_id);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
#endif // VK_USE_PLATFORM_XCB_KHR
inline void dump_vkAcquirePerformanceConfigurationINTEL(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkPerformanceConfigurationAcquireInfoINTEL* pAcquireInfo, VkPerformanceConfigurationINTEL* pConfiguration)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkAcquirePerformanceConfigurationINTEL(dump_inst, result, device, pAcquireInfo, pConfiguration);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkAcquirePerformanceConfigurationINTEL(dump_inst, result, device, pAcquireInfo, pConfiguration);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkAcquirePerformanceConfigurationINTEL(dump_inst, result, device, pAcquireInfo, pConfiguration);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueSetPerformanceConfigurationINTEL(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, VkPerformanceConfigurationINTEL configuration)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkQueueSetPerformanceConfigurationINTEL(dump_inst, result, queue, configuration);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkQueueSetPerformanceConfigurationINTEL(dump_inst, result, queue, configuration);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueSetPerformanceConfigurationINTEL(dump_inst, result, queue, configuration);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateInstance(ApiDumpInstance& dump_inst, VkResult result, const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkInstance* pInstance)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateInstance(dump_inst, result, pCreateInfo, pAllocator, pInstance);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSurfaceSupportKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, VkSurfaceKHR surface, VkBool32* pSupported)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSurfaceSupportKHR(dump_inst, result, physicalDevice, queueFamilyIndex, surface, pSupported);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCreateSamplerYcbcrConversionKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkSamplerYcbcrConversionCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSamplerYcbcrConversion* pYcbcrConversion)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCreateSamplerYcbcrConversionKHR(dump_inst, result, device, pCreateInfo, pAllocator, pYcbcrConversion);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPerformanceParameterINTEL(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPerformanceParameterTypeINTEL parameter, VkPerformanceValueINTEL* pValue)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkGetPerformanceParameterINTEL(dump_inst, result, device, parameter, pValue);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkGetPerformanceParameterINTEL(dump_inst, result, device, parameter, pValue);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPerformanceParameterINTEL(dump_inst, result, device, parameter, pValue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkDebugMarkerSetObjectNameEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDebugMarkerObjectNameInfoEXT* pNameInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDebugMarkerSetObjectNameEXT(dump_inst, result, device, pNameInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkSetDebugUtilsObjectNameEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkDebugUtilsObjectNameInfoEXT* pNameInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkSetDebugUtilsObjectNameEXT(dump_inst, result, device, pNameInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
inline void dump_vkCmdWaitEvents(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t eventCount, const VkEvent* pEvents, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, uint32_t memoryBarrierCount, const VkMemoryBarrier* pMemoryBarriers, uint32_t bufferMemoryBarrierCount, const VkBufferMemoryBarrier* pBufferMemoryBarriers, uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier* pImageMemoryBarriers)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdWaitEvents(dump_inst, commandBuffer, eventCount, pEvents, srcStageMask, dstStageMask, memoryBarrierCount, pMemoryBarriers, bufferMemoryBarrierCount, pBufferMemoryBarriers, imageMemoryBarrierCount, pImageMemoryBarriers);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBindDescriptorSets(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t firstSet, uint32_t descriptorSetCount, const VkDescriptorSet* pDescriptorSets, uint32_t dynamicOffsetCount, const uint32_t* pDynamicOffsets)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBindDescriptorSets(dump_inst, commandBuffer, pipelineBindPoint, layout, firstSet, descriptorSetCount, pDescriptorSets, dynamicOffsetCount, pDynamicOffsets);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkUpdateDescriptorSets(ApiDumpInstance& dump_inst, VkDevice device, uint32_t descriptorWriteCount, const VkWriteDescriptorSet* pDescriptorWrites, uint32_t descriptorCopyCount, const VkCopyDescriptorSet* pDescriptorCopies)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkUpdateDescriptorSets(dump_inst, device, descriptorWriteCount, pDescriptorWrites, descriptorCopyCount, pDescriptorCopies);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginQueryIndexedEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query, VkQueryControlFlags flags, uint32_t index)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginQueryIndexedEXT(dump_inst, commandBuffer, queryPool, query, flags, index);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetDepthBounds(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, float minDepthBounds, float maxDepthBounds)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetDepthBounds(dump_inst, commandBuffer, minDepthBounds, maxDepthBounds);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetStencilCompareMask(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t compareMask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetStencilCompareMask(dump_inst, commandBuffer, faceMask, compareMask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndQueryIndexedEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query, uint32_t index)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndQueryIndexedEXT(dump_inst, commandBuffer, queryPool, query, index);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageSparseMemoryRequirements(ApiDumpInstance& dump_inst, VkDevice device, VkImage image, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements* pSparseMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageSparseMemoryRequirements(dump_inst, device, image, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkSetHdrMetadataEXT(ApiDumpInstance& dump_inst, VkDevice device, uint32_t swapchainCount, const VkSwapchainKHR* pSwapchains, const VkHdrMetadataEXT* pMetadata)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkSetHdrMetadataEXT(dump_inst, device, swapchainCount, pSwapchains, pMetadata);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetEvent(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags stageMask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetEvent(dump_inst, commandBuffer, event, stageMask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdResetEvent(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkEvent event, VkPipelineStageFlags stageMask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdResetEvent(dump_inst, commandBuffer, event, stageMask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndirectByteCountEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t instanceCount, uint32_t firstInstance, VkBuffer counterBuffer, VkDeviceSize counterBufferOffset, uint32_t counterOffset, uint32_t vertexStride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndirectByteCountEXT(dump_inst, commandBuffer, instanceCount, firstInstance, counterBuffer, counterBufferOffset, counterOffset, vertexStride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetBufferMemoryRequirements(ApiDumpInstance& dump_inst, VkDevice device, VkBuffer buffer, VkMemoryRequirements* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetBufferMemoryRequirements(dump_inst, device, buffer, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetStencilWriteMask(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t writeMask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetStencilWriteMask(dump_inst, commandBuffer, faceMask, writeMask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageMemoryRequirements(ApiDumpInstance& dump_inst, VkDevice device, VkImage image, VkMemoryRequirements* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageMemoryRequirements(dump_inst, device, image, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetStencilReference(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, uint32_t reference)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetStencilReference(dump_inst, commandBuffer, faceMask, reference);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetDiscardRectangleEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstDiscardRectangle, uint32_t discardRectangleCount, const VkRect2D* pDiscardRectangles)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetDiscardRectangleEXT(dump_inst, commandBuffer, firstDiscardRectangle, discardRectangleCount, pDiscardRectangles);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkUpdateDescriptorSetWithTemplate(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorSet descriptorSet, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkUpdateDescriptorSetWithTemplate(dump_inst, device, descriptorSet, descriptorUpdateTemplate, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBindIndexBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkIndexType indexType)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBindIndexBuffer(dump_inst, commandBuffer, buffer, offset, indexType);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDescriptorUpdateTemplate(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDescriptorUpdateTemplate(dump_inst, device, descriptorUpdateTemplate, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdNextSubpass2KHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkSubpassBeginInfoKHR*      pSubpassBeginInfo, const VkSubpassEndInfoKHR*        pSubpassEndInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdNextSubpass2KHR(dump_inst, commandBuffer, pSubpassBeginInfo, pSubpassEndInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBindVertexBuffers(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBindVertexBuffers(dump_inst, commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdPipelineBarrier(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, VkDependencyFlags dependencyFlags, uint32_t memoryBarrierCount, const VkMemoryBarrier* pMemoryBarriers, uint32_t bufferMemoryBarrierCount, const VkBufferMemoryBarrier* pBufferMemoryBarriers, uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier* pImageMemoryBarriers)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdPipelineBarrier(dump_inst, commandBuffer, srcStageMask, dstStageMask, dependencyFlags, memoryBarrierCount, pMemoryBarriers, bufferMemoryBarrierCount, pBufferMemoryBarriers, imageMemoryBarrierCount, pImageMemoryBarriers);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDraw(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDraw(dump_inst, commandBuffer, vertexCount, instanceCount, firstVertex, firstInstance);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSparseImageFormatProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkFormat format, VkImageType type, VkSampleCountFlagBits samples, VkImageUsageFlags usage, VkImageTiling tiling, uint32_t* pPropertyCount, VkSparseImageFormatProperties* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSparseImageFormatProperties(dump_inst, physicalDevice, format, type, samples, usage, tiling, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndexed(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, int32_t vertexOffset, uint32_t firstInstance)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndexed(dump_inst, commandBuffer, indexCount, instanceCount, firstIndex, vertexOffset, firstInstance);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkResetQueryPoolEXT(ApiDumpInstance& dump_inst, VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkResetQueryPoolEXT(dump_inst, device, queryPool, firstQuery, queryCount);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkResetQueryPoolEXT(dump_inst, device, queryPool, firstQuery, queryCount);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkResetQueryPoolEXT(dump_inst, device, queryPool, firstQuery, queryCount);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndirect(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndirect(dump_inst, commandBuffer, buffer, offset, drawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginRenderPass2KHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo*      pRenderPassBegin, const VkSubpassBeginInfoKHR*      pSubpassBeginInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginRenderPass2KHR(dump_inst, commandBuffer, pRenderPassBegin, pSubpassBeginInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyFramebuffer(ApiDumpInstance& dump_inst, VkDevice device, VkFramebuffer framebuffer, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyFramebuffer(dump_inst, device, framebuffer, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndexedIndirect(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndexedIndirect(dump_inst, commandBuffer, buffer, offset, drawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginQuery(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query, VkQueryControlFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginQuery(dump_inst, commandBuffer, queryPool, query, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyFence(ApiDumpInstance& dump_inst, VkDevice device, VkFence fence, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyFence(dump_inst, device, fence, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdResetQueryPool(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdResetQueryPool(dump_inst, commandBuffer, queryPool, firstQuery, queryCount);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndQuery(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndQuery(dump_inst, commandBuffer, queryPool, query);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceFeatures(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceFeatures* pFeatures)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceFeatures(dump_inst, physicalDevice, pFeatures);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdWriteTimestamp(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineStageFlagBits pipelineStage, VkQueryPool queryPool, uint32_t query)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdWriteTimestamp(dump_inst, commandBuffer, pipelineStage, queryPool, query);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkTrimCommandPoolKHR(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool, VkCommandPoolTrimFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkTrimCommandPoolKHR(dump_inst, device, commandPool, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdPushConstants(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineLayout layout, VkShaderStageFlags stageFlags, uint32_t offset, uint32_t size, const void* pValues)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdPushConstants(dump_inst, commandBuffer, layout, stageFlags, offset, size, pValues);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdCopyQueryPoolResults(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize stride, VkQueryResultFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdCopyQueryPoolResults(dump_inst, commandBuffer, queryPool, firstQuery, queryCount, dstBuffer, dstOffset, stride, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceFeatures2(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceFeatures2* pFeatures)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceFeatures2(dump_inst, physicalDevice, pFeatures);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalBufferPropertiesKHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalBufferInfo* pExternalBufferInfo, VkExternalBufferProperties* pExternalBufferProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalBufferPropertiesKHR(dump_inst, physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetRenderAreaGranularity(ApiDumpInstance& dump_inst, VkDevice device, VkRenderPass renderPass, VkExtent2D* pGranularity)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetRenderAreaGranularity(dump_inst, device, renderPass, pGranularity);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageSparseMemoryRequirements2(ApiDumpInstance& dump_inst, VkDevice device, const VkImageSparseMemoryRequirementsInfo2* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageSparseMemoryRequirements2(dump_inst, device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageMemoryRequirements2(ApiDumpInstance& dump_inst, VkDevice device, const VkImageMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageMemoryRequirements2(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceProperties2(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties2* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceProperties2(dump_inst, physicalDevice, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyRenderPass(ApiDumpInstance& dump_inst, VkDevice device, VkRenderPass renderPass, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyRenderPass(dump_inst, device, renderPass, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdNextSubpass(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkSubpassContents contents)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdNextSubpass(dump_inst, commandBuffer, contents);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetBufferMemoryRequirements2(ApiDumpInstance& dump_inst, VkDevice device, const VkBufferMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetBufferMemoryRequirements2(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceMemoryProperties2(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceMemoryProperties2* pMemoryProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceMemoryProperties2(dump_inst, physicalDevice, pMemoryProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceFormatProperties2(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkFormat format, VkFormatProperties2* pFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceFormatProperties2(dump_inst, physicalDevice, format, pFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginRenderPass(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassContents contents)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginRenderPass(dump_inst, commandBuffer, pRenderPassBegin, contents);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSparseImageFormatProperties2(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint32_t* pPropertyCount, VkSparseImageFormatProperties2* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSparseImageFormatProperties2(dump_inst, physicalDevice, pFormatInfo, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceQueueFamilyProperties2(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, uint32_t* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceQueueFamilyProperties2(dump_inst, physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkFreeCommandBuffers(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool, uint32_t commandBufferCount, const VkCommandBuffer* pCommandBuffers)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkFreeCommandBuffers(dump_inst, device, commandPool, commandBufferCount, pCommandBuffers);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkTrimCommandPool(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool, VkCommandPoolTrimFlags flags)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkTrimCommandPool(dump_inst, device, commandPool, flags);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyCommandPool(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyCommandPool(dump_inst, device, commandPool, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndRenderPass(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndRenderPass(dump_inst, commandBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdExecuteCommands(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t commandBufferCount, const VkCommandBuffer* pCommandBuffers)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdExecuteCommands(dump_inst, commandBuffer, commandBufferCount, pCommandBuffers);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndRenderPass2KHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkSubpassEndInfoKHR*        pSubpassEndInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndRenderPass2KHR(dump_inst, commandBuffer, pSubpassEndInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdUpdateBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize dataSize, const void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdUpdateBuffer(dump_inst, commandBuffer, dstBuffer, dstOffset, dataSize, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceGroupPeerMemoryFeatures(ApiDumpInstance& dump_inst, VkDevice device, uint32_t heapIndex, uint32_t localDeviceIndex, uint32_t remoteDeviceIndex, VkPeerMemoryFeatureFlags* pPeerMemoryFeatures)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceGroupPeerMemoryFeatures(dump_inst, device, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceQueue2(ApiDumpInstance& dump_inst, VkDevice device, const VkDeviceQueueInfo2* pQueueInfo, VkQueue* pQueue)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceQueue2(dump_inst, device, pQueueInfo, pQueue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueInsertDebugUtilsLabelEXT(ApiDumpInstance& dump_inst, VkQueue queue, const VkDebugUtilsLabelEXT* pLabelInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueInsertDebugUtilsLabelEXT(dump_inst, queue, pLabelInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueBeginDebugUtilsLabelEXT(ApiDumpInstance& dump_inst, VkQueue queue, const VkDebugUtilsLabelEXT* pLabelInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueBeginDebugUtilsLabelEXT(dump_inst, queue, pLabelInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdFillBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer dstBuffer, VkDeviceSize dstOffset, VkDeviceSize size, uint32_t data)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdFillBuffer(dump_inst, commandBuffer, dstBuffer, dstOffset, size, data);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkQueueEndDebugUtilsLabelEXT(ApiDumpInstance& dump_inst, VkQueue queue)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkQueueEndDebugUtilsLabelEXT(dump_inst, queue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdClearColorImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, const VkClearColorValue* pColor, uint32_t rangeCount, const VkImageSubresourceRange* pRanges)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdClearColorImage(dump_inst, commandBuffer, image, imageLayout, pColor, rangeCount, pRanges);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalFencePropertiesKHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalFenceInfo* pExternalFenceInfo, VkExternalFenceProperties* pExternalFenceProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalFencePropertiesKHR(dump_inst, physicalDevice, pExternalFenceInfo, pExternalFenceProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginDebugUtilsLabelEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkDebugUtilsLabelEXT* pLabelInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginDebugUtilsLabelEXT(dump_inst, commandBuffer, pLabelInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndDebugUtilsLabelEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndDebugUtilsLabelEXT(dump_inst, commandBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetDeviceMask(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t deviceMask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetDeviceMask(dump_inst, commandBuffer, deviceMask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdInsertDebugUtilsLabelEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkDebugUtilsLabelEXT* pLabelInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdInsertDebugUtilsLabelEXT(dump_inst, commandBuffer, pLabelInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdClearDepthStencilImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout, const VkClearDepthStencilValue* pDepthStencil, uint32_t rangeCount, const VkImageSubresourceRange* pRanges)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdClearDepthStencilImage(dump_inst, commandBuffer, image, imageLayout, pDepthStencil, rangeCount, pRanges);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdPushDescriptorSetKHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout layout, uint32_t set, uint32_t descriptorWriteCount, const VkWriteDescriptorSet* pDescriptorWrites)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdPushDescriptorSetKHR(dump_inst, commandBuffer, pipelineBindPoint, layout, set, descriptorWriteCount, pDescriptorWrites);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDispatchBase(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t baseGroupX, uint32_t baseGroupY, uint32_t baseGroupZ, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDispatchBase(dump_inst, commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkSubmitDebugUtilsMessageEXT(ApiDumpInstance& dump_inst, VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkSubmitDebugUtilsMessageEXT(dump_inst, instance, messageSeverity, messageTypes, pCallbackData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroySemaphore(ApiDumpInstance& dump_inst, VkDevice device, VkSemaphore semaphore, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroySemaphore(dump_inst, device, semaphore, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdClearAttachments(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t attachmentCount, const VkClearAttachment* pAttachments, uint32_t rectCount, const VkClearRect* pRects)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdClearAttachments(dump_inst, commandBuffer, attachmentCount, pAttachments, rectCount, pRects);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDebugUtilsMessengerEXT(ApiDumpInstance& dump_inst, VkInstance instance, VkDebugUtilsMessengerEXT messenger, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDebugUtilsMessengerEXT(dump_inst, instance, messenger, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdPushDescriptorSetWithTemplateKHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkDescriptorUpdateTemplate descriptorUpdateTemplate, VkPipelineLayout layout, uint32_t set, const void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdPushDescriptorSetWithTemplateKHR(dump_inst, commandBuffer, descriptorUpdateTemplate, layout, set, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyPipeline(ApiDumpInstance& dump_inst, VkDevice device, VkPipeline pipeline, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyPipeline(dump_inst, device, pipeline, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyEvent(ApiDumpInstance& dump_inst, VkDevice device, VkEvent event, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyEvent(dump_inst, device, event, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyPipelineLayout(ApiDumpInstance& dump_inst, VkDevice device, VkPipelineLayout pipelineLayout, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyPipelineLayout(dump_inst, device, pipelineLayout, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdResolveImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageResolve* pRegions)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdResolveImage(dump_inst, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroySamplerYcbcrConversion(ApiDumpInstance& dump_inst, VkDevice device, VkSamplerYcbcrConversion ycbcrConversion, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroySamplerYcbcrConversion(dump_inst, device, ycbcrConversion, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetSampleLocationsEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkSampleLocationsInfoEXT* pSampleLocationsInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetSampleLocationsEXT(dump_inst, commandBuffer, pSampleLocationsInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageSparseMemoryRequirements2KHR(ApiDumpInstance& dump_inst, VkDevice device, const VkImageSparseMemoryRequirementsInfo2* pInfo, uint32_t* pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2* pSparseMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageSparseMemoryRequirements2KHR(dump_inst, device, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceMultisamplePropertiesEXT(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkSampleCountFlagBits samples, VkMultisamplePropertiesEXT* pMultisampleProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceMultisamplePropertiesEXT(dump_inst, physicalDevice, samples, pMultisampleProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageMemoryRequirements2KHR(ApiDumpInstance& dump_inst, VkDevice device, const VkImageMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageMemoryRequirements2KHR(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetBufferMemoryRequirements2KHR(ApiDumpInstance& dump_inst, VkDevice device, const VkBufferMemoryRequirementsInfo2* pInfo, VkMemoryRequirements2* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetBufferMemoryRequirements2KHR(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDebugReportCallbackEXT(ApiDumpInstance& dump_inst, VkInstance instance, VkDebugReportCallbackEXT callback, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDebugReportCallbackEXT(dump_inst, instance, callback, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetViewportShadingRatePaletteNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, const VkShadingRatePaletteNV* pShadingRatePalettes)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetViewportShadingRatePaletteNV(dump_inst, commandBuffer, firstViewport, viewportCount, pShadingRatePalettes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceFormatProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkFormat format, VkFormatProperties* pFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceFormatProperties(dump_inst, physicalDevice, format, pFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdProcessCommandsNVX(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkCmdProcessCommandsInfoNVX* pProcessCommandsInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdProcessCommandsNVX(dump_inst, commandBuffer, pProcessCommandsInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBindShadingRateImageNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImageView imageView, VkImageLayout imageLayout)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBindShadingRateImageNV(dump_inst, commandBuffer, imageView, imageLayout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdReserveSpaceForCommandsNVX(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkCmdReserveSpaceForCommandsInfoNVX* pReserveSpaceInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdReserveSpaceForCommandsNVX(dump_inst, commandBuffer, pReserveSpaceInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetCoarseSampleOrderNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkCoarseSampleOrderTypeNV sampleOrderType, uint32_t customSampleOrderCount, const VkCoarseSampleOrderCustomNV* pCustomSampleOrders)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetCoarseSampleOrderNV(dump_inst, commandBuffer, sampleOrderType, customSampleOrderCount, pCustomSampleOrders);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyIndirectCommandsLayoutNVX(ApiDumpInstance& dump_inst, VkDevice device, VkIndirectCommandsLayoutNVX indirectCommandsLayout, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyIndirectCommandsLayoutNVX(dump_inst, device, indirectCommandsLayout, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroySwapchainKHR(ApiDumpInstance& dump_inst, VkDevice device, VkSwapchainKHR swapchain, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroySwapchainKHR(dump_inst, device, swapchain, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyObjectTableNVX(ApiDumpInstance& dump_inst, VkDevice device, VkObjectTableNVX objectTable, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyObjectTableNVX(dump_inst, device, objectTable, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetViewport(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, const VkViewport* pViewports)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetViewport(dump_inst, commandBuffer, firstViewport, viewportCount, pViewports);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBindPipeline(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBindPipeline(dump_inst, commandBuffer, pipelineBindPoint, pipeline);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetLineWidth(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, float lineWidth)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetLineWidth(dump_inst, commandBuffer, lineWidth);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetScissor(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstScissor, uint32_t scissorCount, const VkRect2D* pScissors)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetScissor(dump_inst, commandBuffer, firstScissor, scissorCount, pScissors);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetDepthBias(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, float depthBiasConstantFactor, float depthBiasClamp, float depthBiasSlopeFactor)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetDepthBias(dump_inst, commandBuffer, depthBiasConstantFactor, depthBiasClamp, depthBiasSlopeFactor);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkDeviceGeneratedCommandsFeaturesNVX* pFeatures, VkDeviceGeneratedCommandsLimitsNVX* pLimits)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX(dump_inst, physicalDevice, pFeatures, pLimits);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetViewportWScalingNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstViewport, uint32_t viewportCount, const VkViewportWScalingNV* pViewportWScalings)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetViewportWScalingNV(dump_inst, commandBuffer, firstViewport, viewportCount, pViewportWScalings);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetBlendConstants(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const float blendConstants[4])
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetBlendConstants(dump_inst, commandBuffer, blendConstants);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetImageSubresourceLayout(ApiDumpInstance& dump_inst, VkDevice device, VkImage image, const VkImageSubresource* pSubresource, VkSubresourceLayout* pLayout)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetImageSubresourceLayout(dump_inst, device, image, pSubresource, pLayout);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndirectCountAMD(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndirectCountAMD(dump_inst, commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndexedIndirectCountAMD(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndexedIndirectCountAMD(dump_inst, commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroySurfaceKHR(ApiDumpInstance& dump_inst, VkInstance instance, VkSurfaceKHR surface, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroySurfaceKHR(dump_inst, instance, surface, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyQueryPool(ApiDumpInstance& dump_inst, VkDevice device, VkQueryPool queryPool, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyQueryPool(dump_inst, device, queryPool, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceMemoryProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceMemoryProperties* pMemoryProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceMemoryProperties(dump_inst, physicalDevice, pMemoryProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDescriptorPool(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorPool descriptorPool, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDescriptorPool(dump_inst, device, descriptorPool, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceQueueFamilyProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, uint32_t* pQueueFamilyPropertyCount, VkQueueFamilyProperties* pQueueFamilyProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceQueueFamilyProperties(dump_inst, physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroySampler(ApiDumpInstance& dump_inst, VkDevice device, VkSampler sampler, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroySampler(dump_inst, device, sampler, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceMemoryProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceMemoryProperties2* pMemoryProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceMemoryProperties2KHR(dump_inst, physicalDevice, pMemoryProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDispatch(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDispatch(dump_inst, commandBuffer, groupCountX, groupCountY, groupCountZ);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdCopyBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkBuffer dstBuffer, uint32_t regionCount, const VkBufferCopy* pRegions)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdCopyBuffer(dump_inst, commandBuffer, srcBuffer, dstBuffer, regionCount, pRegions);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyValidationCacheEXT(ApiDumpInstance& dump_inst, VkDevice device, VkValidationCacheEXT validationCache, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyValidationCacheEXT(dump_inst, device, validationCache, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSparseImageFormatInfo2* pFormatInfo, uint32_t* pPropertyCount, VkSparseImageFormatProperties2* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(dump_inst, physicalDevice, pFormatInfo, pPropertyCount, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyImageView(ApiDumpInstance& dump_inst, VkDevice device, VkImageView imageView, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyImageView(dump_inst, device, imageView, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceQueueFamilyProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, uint32_t* pQueueFamilyPropertyCount, VkQueueFamilyProperties2* pQueueFamilyProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceQueueFamilyProperties2KHR(dump_inst, physicalDevice, pQueueFamilyPropertyCount, pQueueFamilyProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDispatchIndirect(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDispatchIndirect(dump_inst, commandBuffer, buffer, offset);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdCopyImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageCopy* pRegions)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdCopyImage(dump_inst, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceGroupPeerMemoryFeaturesKHR(ApiDumpInstance& dump_inst, VkDevice device, uint32_t heapIndex, uint32_t localDeviceIndex, uint32_t remoteDeviceIndex, VkPeerMemoryFeatureFlags* pPeerMemoryFeatures)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceGroupPeerMemoryFeaturesKHR(dump_inst, device, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetDeviceMaskKHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t deviceMask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetDeviceMaskKHR(dump_inst, commandBuffer, deviceMask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBlitImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkImageBlit* pRegions, VkFilter filter)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBlitImage(dump_inst, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout, regionCount, pRegions, filter);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDescriptorSetLayout(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorSetLayout descriptorSetLayout, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDescriptorSetLayout(dump_inst, device, descriptorSetLayout, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceQueue(ApiDumpInstance& dump_inst, VkDevice device, uint32_t queueFamilyIndex, uint32_t queueIndex, VkQueue* pQueue)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceQueue(dump_inst, device, queueFamilyIndex, queueIndex, pQueue);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDispatchBaseKHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t baseGroupX, uint32_t baseGroupY, uint32_t baseGroupZ, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDispatchBaseKHR(dump_inst, commandBuffer, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalBufferProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalBufferInfo* pExternalBufferInfo, VkExternalBufferProperties* pExternalBufferProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalBufferProperties(dump_inst, physicalDevice, pExternalBufferInfo, pExternalBufferProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBuildAccelerationStructureNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkAccelerationStructureInfoNV* pInfo, VkBuffer instanceData, VkDeviceSize instanceOffset, VkBool32 update, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkBuffer scratch, VkDeviceSize scratchOffset)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBuildAccelerationStructureNV(dump_inst, commandBuffer, pInfo, instanceData, instanceOffset, update, dst, src, scratch, scratchOffset);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyShaderModule(ApiDumpInstance& dump_inst, VkDevice device, VkShaderModule shaderModule, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyShaderModule(dump_inst, device, shaderModule, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetAccelerationStructureMemoryRequirementsNV(ApiDumpInstance& dump_inst, VkDevice device, const VkAccelerationStructureMemoryRequirementsInfoNV* pInfo, VkMemoryRequirements2KHR* pMemoryRequirements)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetAccelerationStructureMemoryRequirementsNV(dump_inst, device, pInfo, pMemoryRequirements);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyAccelerationStructureNV(ApiDumpInstance& dump_inst, VkDevice device, VkAccelerationStructureNV accelerationStructure, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyAccelerationStructureNV(dump_inst, device, accelerationStructure, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkUnmapMemory(ApiDumpInstance& dump_inst, VkDevice device, VkDeviceMemory memory)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkUnmapMemory(dump_inst, device, memory);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkFreeMemory(ApiDumpInstance& dump_inst, VkDevice device, VkDeviceMemory memory, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkFreeMemory(dump_inst, device, memory, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalSemaphoreInfo* pExternalSemaphoreInfo, VkExternalSemaphoreProperties* pExternalSemaphoreProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalSemaphorePropertiesKHR(dump_inst, physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDebugMarkerBeginEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDebugMarkerBeginEXT(dump_inst, commandBuffer, pMarkerInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBindTransformFeedbackBuffersEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets, const VkDeviceSize* pSizes)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBindTransformFeedbackBuffersEXT(dump_inst, commandBuffer, firstBinding, bindingCount, pBuffers, pOffsets, pSizes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdCopyBufferToImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkImage dstImage, VkImageLayout dstImageLayout, uint32_t regionCount, const VkBufferImageCopy* pRegions)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdCopyBufferToImage(dump_inst, commandBuffer, srcBuffer, dstImage, dstImageLayout, regionCount, pRegions);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdCopyAccelerationStructureNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkAccelerationStructureNV dst, VkAccelerationStructureNV src, VkCopyAccelerationStructureModeNV mode)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdCopyAccelerationStructureNV(dump_inst, commandBuffer, dst, src, mode);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDebugMarkerEndEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDebugMarkerEndEXT(dump_inst, commandBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawMeshTasksIndirectNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, uint32_t drawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawMeshTasksIndirectNV(dump_inst, commandBuffer, buffer, offset, drawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDebugMarkerInsertEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDebugMarkerInsertEXT(dump_inst, commandBuffer, pMarkerInfo);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDevice(ApiDumpInstance& dump_inst, VkDevice device, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDevice(dump_inst, device, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawMeshTasksIndirectCountNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawMeshTasksIndirectCountNV(dump_inst, commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDeviceMemoryCommitment(ApiDumpInstance& dump_inst, VkDevice device, VkDeviceMemory memory, VkDeviceSize* pCommittedMemoryInBytes)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDeviceMemoryCommitment(dump_inst, device, memory, pCommittedMemoryInBytes);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawMeshTasksNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t taskCount, uint32_t firstTask)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawMeshTasksNV(dump_inst, commandBuffer, taskCount, firstTask);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyPipelineCache(ApiDumpInstance& dump_inst, VkDevice device, VkPipelineCache pipelineCache, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyPipelineCache(dump_inst, device, pipelineCache, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdTraceRaysNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer raygenShaderBindingTableBuffer, VkDeviceSize raygenShaderBindingOffset, VkBuffer missShaderBindingTableBuffer, VkDeviceSize missShaderBindingOffset, VkDeviceSize missShaderBindingStride, VkBuffer hitShaderBindingTableBuffer, VkDeviceSize hitShaderBindingOffset, VkDeviceSize hitShaderBindingStride, VkBuffer callableShaderBindingTableBuffer, VkDeviceSize callableShaderBindingOffset, VkDeviceSize callableShaderBindingStride, uint32_t width, uint32_t height, uint32_t depth)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdTraceRaysNV(dump_inst, commandBuffer, raygenShaderBindingTableBuffer, raygenShaderBindingOffset, missShaderBindingTableBuffer, missShaderBindingOffset, missShaderBindingStride, hitShaderBindingTableBuffer, hitShaderBindingOffset, hitShaderBindingStride, callableShaderBindingTableBuffer, callableShaderBindingOffset, callableShaderBindingStride, width, height, depth);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginTransformFeedbackEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstCounterBuffer, uint32_t counterBufferCount, const VkBuffer* pCounterBuffers, const VkDeviceSize* pCounterBufferOffsets)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginTransformFeedbackEXT(dump_inst, commandBuffer, firstCounterBuffer, counterBufferCount, pCounterBuffers, pCounterBufferOffsets);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdCopyImageToBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage, VkImageLayout srcImageLayout, VkBuffer dstBuffer, uint32_t regionCount, const VkBufferImageCopy* pRegions)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdCopyImageToBuffer(dump_inst, commandBuffer, srcImage, srcImageLayout, dstBuffer, regionCount, pRegions);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalFenceProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalFenceInfo* pExternalFenceInfo, VkExternalFenceProperties* pExternalFenceProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalFenceProperties(dump_inst, physicalDevice, pExternalFenceInfo, pExternalFenceProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndTransformFeedbackEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstCounterBuffer, uint32_t counterBufferCount, const VkBuffer* pCounterBuffers, const VkDeviceSize* pCounterBufferOffsets)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndTransformFeedbackEXT(dump_inst, commandBuffer, firstCounterBuffer, counterBufferCount, pCounterBuffers, pCounterBufferOffsets);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdBeginConditionalRenderingEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const VkConditionalRenderingBeginInfoEXT* pConditionalRenderingBegin)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdBeginConditionalRenderingEXT(dump_inst, commandBuffer, pConditionalRenderingBegin);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDebugReportMessageEXT(ApiDumpInstance& dump_inst, VkInstance instance, VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType, uint64_t object, size_t location, int32_t messageCode, const char* pLayerPrefix, const char* pMessage)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDebugReportMessageEXT(dump_inst, instance, flags, objectType, object, location, messageCode, pLayerPrefix, pMessage);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdEndConditionalRenderingEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdEndConditionalRenderingEXT(dump_inst, commandBuffer);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetExclusiveScissorNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstExclusiveScissor, uint32_t exclusiveScissorCount, const VkRect2D* pExclusiveScissors)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetExclusiveScissorNV(dump_inst, commandBuffer, firstExclusiveScissor, exclusiveScissorCount, pExclusiveScissors);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdWriteAccelerationStructuresPropertiesNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t accelerationStructureCount, const VkAccelerationStructureNV* pAccelerationStructures, VkQueryType queryType, VkQueryPool queryPool, uint32_t firstQuery)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdWriteAccelerationStructuresPropertiesNV(dump_inst, commandBuffer, accelerationStructureCount, pAccelerationStructures, queryType, queryPool, firstQuery);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdSetCheckpointNV(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const void* pCheckpointMarker)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdSetCheckpointNV(dump_inst, commandBuffer, pCheckpointMarker);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkSetLocalDimmingAMD(ApiDumpInstance& dump_inst, VkDevice device, VkSwapchainKHR swapChain, VkBool32 localDimmingEnable)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkSetLocalDimmingAMD(dump_inst, device, swapChain, localDimmingEnable);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkSetLocalDimmingAMD(dump_inst, device, swapChain, localDimmingEnable);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkSetLocalDimmingAMD(dump_inst, device, swapChain, localDimmingEnable);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyBuffer(ApiDumpInstance& dump_inst, VkDevice device, VkBuffer buffer, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyBuffer(dump_inst, device, buffer, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkUpdateDescriptorSetWithTemplateKHR(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorSet descriptorSet, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const void* pData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkUpdateDescriptorSetWithTemplateKHR(dump_inst, device, descriptorSet, descriptorUpdateTemplate, pData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyDescriptorUpdateTemplateKHR(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyDescriptorUpdateTemplateKHR(dump_inst, device, descriptorUpdateTemplate, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceProperties(dump_inst, physicalDevice, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetQueueCheckpointDataNV(ApiDumpInstance& dump_inst, VkQueue queue, uint32_t* pCheckpointDataCount, VkCheckpointDataNV* pCheckpointData)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetQueueCheckpointDataNV(dump_inst, queue, pCheckpointDataCount, pCheckpointData);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkUninitializePerformanceApiINTEL(ApiDumpInstance& dump_inst, VkDevice device)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
    case ApiDumpFormat::Text:
        dump_text_vkUninitializePerformanceApiINTEL(dump_inst, device);
        break;
    case ApiDumpFormat::Html:
        dump_html_vkUninitializePerformanceApiINTEL(dump_inst, device);
        break;
    case ApiDumpFormat::Json:
        dump_json_vkUninitializePerformanceApiINTEL(dump_inst, device);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceExternalSemaphoreProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, const VkPhysicalDeviceExternalSemaphoreInfo* pExternalSemaphoreInfo, VkExternalSemaphoreProperties* pExternalSemaphoreProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceExternalSemaphoreProperties(dump_inst, physicalDevice, pExternalSemaphoreInfo, pExternalSemaphoreProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndirectCountKHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndirectCountKHR(dump_inst, commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyBufferView(ApiDumpInstance& dump_inst, VkDevice device, VkBufferView bufferView, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyBufferView(dump_inst, device, bufferView, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdWriteBufferMarkerAMD(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineStageFlagBits pipelineStage, VkBuffer dstBuffer, VkDeviceSize dstOffset, uint32_t marker)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdWriteBufferMarkerAMD(dump_inst, commandBuffer, pipelineStage, dstBuffer, dstOffset, marker);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDescriptorSetLayoutSupportKHR(ApiDumpInstance& dump_inst, VkDevice device, const VkDescriptorSetLayoutCreateInfo* pCreateInfo, VkDescriptorSetLayoutSupport* pSupport)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDescriptorSetLayoutSupportKHR(dump_inst, device, pCreateInfo, pSupport);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyImage(ApiDumpInstance& dump_inst, VkDevice device, VkImage image, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyImage(dump_inst, device, image, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkCmdDrawIndexedIndirectCountKHR(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkCmdDrawIndexedIndirectCountKHR(dump_inst, commandBuffer, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceFeatures2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceFeatures2* pFeatures)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceFeatures2KHR(dump_inst, physicalDevice, pFeatures);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetDescriptorSetLayoutSupport(ApiDumpInstance& dump_inst, VkDevice device, const VkDescriptorSetLayoutCreateInfo* pCreateInfo, VkDescriptorSetLayoutSupport* pSupport)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetDescriptorSetLayoutSupport(dump_inst, device, pCreateInfo, pSupport);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroyInstance(ApiDumpInstance& dump_inst, VkInstance instance, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroyInstance(dump_inst, instance, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceFormatProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkFormat format, VkFormatProperties2* pFormatProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceFormatProperties2KHR(dump_inst, physicalDevice, format, pFormatProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkGetPhysicalDeviceProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkPhysicalDeviceProperties2* pProperties)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkGetPhysicalDeviceProperties2KHR(dump_inst, physicalDevice, pProperties);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
inline void dump_vkDestroySamplerYcbcrConversionKHR(ApiDumpInstance& dump_inst, VkDevice device, VkSamplerYcbcrConversion ycbcrConversion, const VkAllocationCallbacks* pAllocator)
{
    ...
    case ApiDumpFormat::Html:
        ...
        break;
    case ApiDumpFormat::Json:
        dump_json_vkDestroySamplerYcbcrConversionKHR(dump_inst, device, ycbcrConversion, pAllocator);
        break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceSurfacePresentModes2EXT(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes)
{
    ...
    dump_vkGetPhysicalDeviceSurfacePresentModes2EXT(ApiDumpInstance::current(), result, physicalDevice, pSurfaceInfo, pPresentModeCount, pPresentModes);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHR
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateHeadlessSurfaceEXT(VkInstance instance, const VkHeadlessSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    dump_vkCreateHeadlessSurfaceEXT(ApiDumpInstance::current(), result, instance, pCreateInfo, pAllocator, pSurface);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateStreamDescriptorSurfaceGGP(VkInstance instance, const VkStreamDescriptorSurfaceCreateInfoGGP* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    dump_vkCreateStreamDescriptorSurfaceGGP(ApiDumpInstance::current(), result, instance, pCreateInfo, pAllocator, pSurface);
    return result;
}
#endif // VK_USE_PLATFORM_GGP
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeMatrixPropertiesNV* pProperties)
{
    ...
    dump_vkGetPhysicalDeviceCooperativeMatrixPropertiesNV(ApiDumpInstance::current(), result, physicalDevice, pPropertyCount, pProperties);
    return result;
}
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(VkPhysicalDevice physicalDevice, uint32_t* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations)
{
    ...
    dump_vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(ApiDumpInstance::current(), result, physicalDevice, pCombinationCount, pCombinations);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCreateMetalSurfaceEXT(VkInstance instance, const VkMetalSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface)
{
    ...
    dump_vkCreateMetalSurfaceEXT(ApiDumpInstance::current(), result, instance, pCreateInfo, pAllocator, pSurface);
    return result;
}
#endif // VK_USE_PLATFORM_METAL_EXT
#if defined(VK_USE_PLATFORM_XCB_KHR)
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkReleaseFullScreenExclusiveModeEXT(VkDevice device, VkSwapchainKHR swapchain)
{
    ...
    dump_vkReleaseFullScreenExclusiveModeEXT(ApiDumpInstance::current(), result, device, swapchain);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHR
#if defined(VK_USE_PLATFORM_WIN32_KHR)
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkAcquireFullScreenExclusiveModeEXT(VkDevice device, VkSwapchainKHR swapchain)
{
    ...
    dump_vkAcquireFullScreenExclusiveModeEXT(ApiDumpInstance::current(), result, device, swapchain);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHR
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetDeviceGroupSurfacePresentModes2EXT(VkDevice device, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, VkDeviceGroupPresentModeFlagsKHR* pModes)
{
    ...
    dump_vkGetDeviceGroupSurfacePresentModes2EXT(ApiDumpInstance::current(), result, device, pSurfaceInfo, pModes);
    return result;
}
#endif // VK_USE_PLATFORM_WIN32_KHR
...
VK_LAYER_EXPORT VKAPI_ATTR uint32_t VKAPI_CALL vkGetImageViewHandleNVX(VkDevice device, const VkImageViewHandleInfoNVX* pInfo)
{
    ...
    dump_vkGetImageViewHandleNVX(ApiDumpInstance::current(), result, device, pInfo);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkInitializePerformanceApiINTEL(VkDevice device, const VkInitializePerformanceApiInfoINTEL* pInitializeInfo)
{
    ...
    dump_vkInitializePerformanceApiINTEL(ApiDumpInstance::current(), result, device, pInitializeInfo);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCmdSetPerformanceMarkerINTEL(VkCommandBuffer commandBuffer, const VkPerformanceMarkerInfoINTEL* pMarkerInfo)
{
    ...
    dump_vkCmdSetPerformanceMarkerINTEL(ApiDumpInstance::current(), result, commandBuffer, pMarkerInfo);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCmdSetPerformanceStreamMarkerINTEL(VkCommandBuffer commandBuffer, const VkPerformanceStreamMarkerInfoINTEL* pMarkerInfo)
{
    ...
    dump_vkCmdSetPerformanceStreamMarkerINTEL(ApiDumpInstance::current(), result, commandBuffer, pMarkerInfo);
    return result;
}
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkCmdSetPerformanceOverrideINTEL(VkCommandBuffer commandBuffer, const VkPerformanceOverrideInfoINTEL* pOverrideInfo)
{
    ...
    dump_vkCmdSetPerformanceOverrideINTEL(ApiDumpInstance::current(), result, commandBuffer, pOverrideInfo);
    return result;
}
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkReleasePerformanceConfigurationINTEL(VkDevice device, VkPerformanceConfigurationINTEL configuration)
{
    ...
    dump_vkReleasePerformanceConfigurationINTEL(ApiDumpInstance::current(), result, device, configuration);
    return result;
}
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkAcquirePerformanceConfigurationINTEL(VkDevice device, const VkPerformanceConfigurationAcquireInfoINTEL* pAcquireInfo, VkPerformanceConfigurationINTEL* pConfiguration)
{
    ...
    dump_vkAcquirePerformanceConfigurationINTEL(ApiDumpInstance::current(), result, device, pAcquireInfo, pConfiguration);
    return result;
}
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkQueueSetPerformanceConfigurationINTEL(VkQueue queue, VkPerformanceConfigurationINTEL configuration)
{
    ...
    dump_vkQueueSetPerformanceConfigurationINTEL(ApiDumpInstance::current(), result, queue, configuration);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkGetPerformanceParameterINTEL(VkDevice device, VkPerformanceParameterTypeINTEL parameter, VkPerformanceValueINTEL* pValue)
{
    ...
    dump_vkGetPerformanceParameterINTEL(ApiDumpInstance::current(), result, device, parameter, pValue);
    return result;
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkResetQueryPoolEXT(VkDevice device, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount)
{
    ...
    dump_vkResetQueryPoolEXT(ApiDumpInstance::current(), device, queryPool, firstQuery, queryCount);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkSetLocalDimmingAMD(VkDevice device, VkSwapchainKHR swapChain, VkBool32 localDimmingEnable)
{
    ...
    dump_vkSetLocalDimmingAMD(ApiDumpInstance::current(), device, swapChain, localDimmingEnable);
}
...
VK_LAYER_EXPORT VKAPI_ATTR void VKAPI_CALL vkUninitializePerformanceApiINTEL(VkDevice device)
{
    ...
    dump_vkUninitializePerformanceApiINTEL(ApiDumpInstance::current(), device);
}
